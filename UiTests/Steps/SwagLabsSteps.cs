...
namespace UiTests.Steps
{
    ...
    public class SwagLabsSteps
    {
        ...
        public void WhenILogInWith(string user, string pass)
        {
        ...
        {
            _inventory.IsLoaded().Should().BeTrue();
        }

        [When(@"I add ""(.*)"" to the cart")]
        public void WhenIAddToTheCart(string itemName)
        {
            _inventory.AddItemToCartByName(itemName);
        }

        [Then(@"the cart count should be (.*)")]
        public void ThenTheCartCountShouldBe(int expected)
        {
            _inventory.CartCount().Should().Be(expected);
        }
        ...
        public void ThenIShouldSeeInTheCart(string itemName)
        {
            _cart.HasItem(itemName).Should().BeTrue();
        }
